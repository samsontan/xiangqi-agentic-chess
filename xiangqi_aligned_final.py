#!/usr/bin/env python3
"""
Xiangqi with PERFECT Alignment - Accounts for rank number spacing
"""
...
def draw_perfectly_aligned_board(game):
    """Draw board with perfect alignment accounting for rank numbers"""
    piece_map = {
    ...
    # Header with proper spacing to account for rank numbers (2 spaces + space)
    print("\n   [a][b][c][d][e][f][g][h][i]")
...
class PerfectlyAlignedXiangqiGame(FastXiangqiGame):
    def display_board(self):
        """Use perfectly aligned board display"""
        draw_perfectly_aligned_board(self)

def main():
    """Main game with perfect alignment"""
    print("🎮 PERFECTLY ALIGNED XIANGQI - FINAL VERSION")
    print("=" * 50)
    print("🔴 You are RED, ⚫ AI is BLACK")
    print("🚀 AI responds quickly (under 2 seconds)")
    print("📍 File labels [a]-[i] perfectly aligned with pieces!")
    print("Enter moves like: e4-e5 (with dash)")
    print("Type 'quit' to exit")
    print("=" * 50)

    game = PerfectlyAlignedXiangqiGame()
    move_count = 0
