#!/usr/bin/env python3
"""
Xiangqi with Dashes Between File Labels for Better Alignment
"""
...
def draw_dash_board(game):
    """Draw board with dashes between file labels"""
    piece_map = {
    ...
    # Header with dashes between file labels
    print("\n  a-b-c-d-e-f-g-h-i")
...
class DashXiangqiGame(FastXiangqiGame):
    def display_board(self):
        """Use dash board display"""
        draw_dash_board(self)

def main():
    """Main game with dash file labels"""
    print("🎮 XIANGQI WITH DASH FILE LABELS")
    print("=" * 50)
